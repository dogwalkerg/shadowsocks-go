												...
												<div class="tab-pane fade {if $ssr_prefer}active in{/if}" id="all_ssr">
                                                  ...
                                                  <div class="tab-pane fade" id="all_ssr_linux">
													...
													{/if}
														...
														<p><span class="icon icon-lg text-white">filter_1</span> <a href="itms-services://?action=download-manifest&url=https://raw.githubusercontent.com/dogwalkerg/shadowsocks-go/master/shadowsocksgooogle.how381.plist" class="btn-dl"><i class="material-icons">save_alt</i>一键在线安装Shadowrocket</a><code>点击左边一键在线安装Shadowrocket</code>
														...
														<p><span class="icon icon-lg text-white">filter_1</span> <a href="itms-services://?action=download-manifest&url=https://raw.githubusercontent.com/dogwalkerg/shadowsocks-go/master/Quantumult.plist" class="btn-dl"><i class="material-icons">save_alt</i>一键在线安装Quantumult</a><code>点击左边一键在线安装Quantumult</code>
													...
													<p>梅林：</p>
                                                      <p><a href="/user/tutorial">点击这里查看梅林客户端教程</a></p>
